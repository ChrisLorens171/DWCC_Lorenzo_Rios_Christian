 ...
 *   Entrada : --
 *
 *   Salida  : Despues de ejecutar actualizaAlbunes(coleccion, 5439, "artista", "ABBA"), artista debería ser "ABBA"
 *             Despues de ejecutar actualizaAlbunes(coleccion, 5439, "pistas", "Take a Chance on Me"), añadimos la propiedad pistas, que debería tener un array con "Take a Chance on Me" como ultimo elemento.
 *             Despues de ejecutar actualizaAlbunes(coleccion, 2548, "artista", ""), se debería borrar artista
 *             Despues de ejecutar actualizaAlbunes(coleccion, 1245, "pistas", "Addicted to Love"), pistas debería tener "Addicted to Love" como ultimo elemento.
 *             Despues de ejecutar actualizaAlbunes(coleccion, 2468, "pistas", "Free"), pistas debería tener "1999" como primer elemento.
 *             Despues de ejecutar actualizaAlbunes(coleccion, 2548, "pistas", ""), pistas debería vaciarse
 *             Despues de ejecutar actualizaAlbunes(coleccion, 1245, "titulo", "Riptide"), titulo debería ser "Riptide"
 *
 ***************************************************************************************************************/
...
function actualizaAlbunes(coleccion, id, prop, valor) {
  if (valor !== "") {
    if (prop !== "pistas") {
      coleccion[id][prop] = valor;
    } else {
      if (coleccion[id].hasOwnProperty("pistas")) {
        if (!coleccion[id].pistas.includes(valor)) {
...
console.log(actualizaAlbunes(coleccionAlbunes, 5439, "artista", "ABBA"))
//console.log(actualizaAlbunes(coleccionAlbunes, 5439, "pistas", "Take a Chance on Me"))
//console.log(actualizaAlbunes(coleccionAlbunes, 2548, "artista", ""))
//console.log(actualizaAlbunes(coleccionAlbunes, 1245, "pistas", "Addicted to Love"))
//console.log(actualizaAlbunes(coleccionAlbunes, 2468, "pistas", "Free"))
//console.log(actualizaAlbunes(coleccionAlbunes, 2548, "pistas", ""))
//console.log(actualizaAlbunes(coleccionAlbunes, 1245, "titulo", "Riptide"))
